...
const MAX_HASH_VALUE = "21888242871839275222246405745257275088548364400416034343698204186575808495616";

class NullifierTree{

    constructor(hasher,depth,treeID=0){
        ...
        this.insertHashValue(MAX_HASH_VALUE);
